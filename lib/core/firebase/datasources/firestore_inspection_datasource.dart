...
/// Firestore data source for inspection records.
/// Use through the repository layer only — never call from screens directly.
class FirestoreInspectionDatasource {
  FirestoreInspectionDatasource({FirestoreService? firestoreService})
      : _fs = firestoreService ?? FirestoreService.instance;

  final FirestoreService _fs;

  static const _collection = 'inspections';
