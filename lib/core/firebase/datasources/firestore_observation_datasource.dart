...
/// Firestore data source for observation records.
/// Use through the repository layer only — never call from screens directly.
class FirestoreObservationDatasource {
  FirestoreObservationDatasource({FirestoreService? firestoreService})
      : _fs = firestoreService ?? FirestoreService.instance;

  final FirestoreService _fs;

  static const _collection = 'observations';
